...
public class OfferingLocationCampus {
    ...
    static List<String> instructors=new ArrayList<>();

    TxtWriter txtWriterInstance=TxtWriter.getInstance();

    public OfferingLocationCampus(String location, int semester, String subject, String catalogNumber) {
